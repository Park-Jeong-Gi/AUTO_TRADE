...
slack = Slacker('xoxb-1606351762341-1633293658960-UZf4XoQNP7qEQxPsAe0MYPce')
def dbgout(message):
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A069500','A102110','A153130', 'A305720', 'A364980']
        ...
        while True:
            ...
            t_sell = t_now.replace(hour=14, minute=0, second=0, microsecond=0)
